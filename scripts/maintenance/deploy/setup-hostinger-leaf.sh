...
# 🚀 SETUP LEAF APP - HOSTINGER VPS
# Configuração otimizada para VPS com painel existente
...
# 🔧 Tornar executável
chmod +x setup-hostinger-leaf.sh

echo "✅ Script criado: setup-hostinger-leaf.sh"
echo ""
echo "🚀 Para executar na sua VPS:"
echo "1. Copie o arquivo para a VPS"
