...
// 🧪 TESTE DO AJUSTE AUTOMÁTICO - LEAF APP (VERSÃO SIMPLES)
const MINIMUM_FARE = 8.50; // R$ 8,50

function getFinalFareValue(calculatedFare) {
...
function testAutoAdjustment() {
    ...
    console.log('\n📋 CONFIGURAÇÃO:');
    console.log('Valor mínimo definido: R$', MINIMUM_FARE);
    ...
    if (passedTests === totalTests) {
        ...
        console.log('✅ O ajuste automático está funcionando perfeitamente!');
    } else {
        console.log('\n⚠️  ALGUNS TESTES FALHARAM!');
        console.log('❌ Verificar implementação do ajuste automático');
    }
}
