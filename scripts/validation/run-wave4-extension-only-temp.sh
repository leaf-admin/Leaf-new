...
write_summary_file "$SUMMARY_PATH" "# Wave 4 Extension Only Validation

- Run dir: ${RUN_DIR}
- Artifact dir: ${ARTIFACT_DIR}
- Coverage: extension request and driver acceptance
- Rule: 15s before every screenshot
"

log "wave4 extension-only validation finished"
