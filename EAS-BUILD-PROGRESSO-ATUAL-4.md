# 🎯 PROGRESSO ATUAL EAS BUILD - Leaf App (PARTE 4)
...
### **14. ✅ promoComponent.js**
- **Problema:** `Error: Unable to resolve module common/src/other/getLangKey from /home/expo/workingdir/build/src/components/promoComponent.js`
- **Solução:** Corrigida importação de `"common/src/other/getLangKey"` para `"../common-local/other/getLangKey"`
- **Status:** ✅ RESOLVIDO
...
- ✅ promoComponent.js (corrigida importação)
