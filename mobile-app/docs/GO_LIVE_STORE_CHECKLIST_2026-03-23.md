...
- Privacy Policy: `https://api.leaf.app.br/privacy-policy`
- Terms of Service: `https://api.leaf.app.br/terms-of-service`
- Refund Policy: `https://api.leaf.app.br/refund-policy`
- Account Deletion: `https://api.leaf.app.br/account-deletion`
