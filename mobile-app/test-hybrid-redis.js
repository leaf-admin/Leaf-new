// test-hybrid-redis.js - Teste da implementação híbrida Redis + Firebase
import { redisApiService } from './src/services/RedisApiService.js';
import LocalCacheService from './src/services/LocalCacheService.js';
...
export default HybridRedisTester; 