...
require_pattern "src/components/auth/AuthFlow.js" "PasswordLoginStep" "password login flow"
...
require_pattern "src/components/auth/steps/PhoneInputStep.js" "allowReviewAccess" "review OTP gate"
require_pattern "src/components/auth/steps/PhoneInputStep.js" "isReviewAccount" "review account gate"
