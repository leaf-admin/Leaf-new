...
export LEAF_LAUNCH_PROFILE="${LEAF_LAUNCH_PROFILE:-full}"
...
# Product flags for the current UI/flow validation. Keep withdrawals off until
# compliance/idempotency decisions are closed.
export EXPO_PUBLIC_ENABLE_DRIVER_WITHDRAWALS="${EXPO_PUBLIC_ENABLE_DRIVER_WITHDRAWALS:-false}"
export EXPO_PUBLIC_ENABLE_REFERRAL_PROGRAMS="${EXPO_PUBLIC_ENABLE_REFERRAL_PROGRAMS:-true}"
export EXPO_PUBLIC_ENABLE_LEAF_DELAS="${EXPO_PUBLIC_ENABLE_LEAF_DELAS:-true}"
export EXPO_PUBLIC_ENABLE_DRIVER_DESTINATION_MODE="${EXPO_PUBLIC_ENABLE_DRIVER_DESTINATION_MODE:-true}"
export EXPO_PUBLIC_ENABLE_DYNAMIC_PRICING="${EXPO_PUBLIC_ENABLE_DYNAMIC_PRICING:-true}"
export EXPO_PUBLIC_ENABLE_SMART_PUSH="${EXPO_PUBLIC_ENABLE_SMART_PUSH:-false}"
export EXPO_PUBLIC_ENABLE_SOFT_BAN_ENFORCEMENT="${EXPO_PUBLIC_ENABLE_SOFT_BAN_ENFORCEMENT:-true}"
export EXPO_PUBLIC_ENABLE_ADMIN_MUTATIONS="${EXPO_PUBLIC_ENABLE_ADMIN_MUTATIONS:-true}"

# Client-side bypass remains off by default because the current backend already
# has real Woovi sandbox enabled and requires payment before booking.
