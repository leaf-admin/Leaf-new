...
const DRIVER_STATUS_SURFACES = Object.freeze({
  ...
  [RUNTIME_RIDE_STATUSES.SEARCHING]: {
    ...
    routeName: 'RobotaxiPrototypeDriverOffer',
    protected: true,
    terminal: false,
    requiredTestIDs: ['driver-offer-screen', 'driver-offer-screen-summary'],
  },
  [RUNTIME_RIDE_STATUSES.ACCEPTED]: {
    surface: RIDE_LIFECYCLE_SURFACES.DRIVER_TRIP,
    routeName: 'RobotaxiPrototypeDriverTrip',
    protected: true,
    terminal: false,
    requiredTestIDs: ['driver-live-trip-screen', 'driver-trip-passenger-identity'],
  },
  [RUNTIME_RIDE_STATUSES.ARRIVED]: {
    surface: RIDE_LIFECYCLE_SURFACES.DRIVER_TRIP,
    routeName: 'RobotaxiPrototypeDriverTrip',
  ...
  [RUNTIME_RIDE_STATUSES.STARTED]: {
    ...
    protected: true,
    terminal: false,
    requiredTestIDs: ['driver-live-trip-screen', 'driver-trip-route-progress'],
  },
  [RUNTIME_RIDE_STATUSES.OPERATIONAL_INTERRUPTED]: {
    surface: RIDE_LIFECYCLE_SURFACES.DRIVER_TRIP,
    routeName: 'RobotaxiPrototypeDriverTrip',
    protected: true,
    terminal: false,
    requiredTestIDs: ['driver-live-trip-screen', 'driver-trip-operational-hold-title'],
  },
  [RUNTIME_RIDE_STATUSES.SEARCHING_REPLACEMENT]: {
    surface: RIDE_LIFECYCLE_SURFACES.DRIVER_TRIP,
    routeName: 'RobotaxiPrototypeDriverTrip',
