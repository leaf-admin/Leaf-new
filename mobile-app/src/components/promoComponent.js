        ...
        <View style={[styles.fare, styles.shadow,{height: 'auto', flexDirection: isRTL?'row-reverse':'row'}]}>
            <View style={[styles.textViewStyle, {justifyContent:'space-around'}]}>
              <View style={{flexDirection: 'column'}}>
                <Text style={[styles.couponCode,{textAlign: isRTL? "right":"left", }]}>{t(getLangKey(item.promo_name))}</Text>
                <Text style={[styles.textStyle,{textAlign: isRTL? "right":"left", }]}>{t(getLangKey(item.promo_description))}</Text>
