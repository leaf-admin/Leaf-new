                        ...
                        >
                            {
                                tripdata.carType.parcelTypes.map((obj, i) => (
                                    <RadioButton labelHorizontal={true} key={i} style={{flexDirection:isRTL?'row-reverse':'row'}}>
                                        <RadioButtonInput
                                            obj={{ label: settings.swipe_symbol===false? settings.symbol + ' ' + obj.amount + ' - ' + t(getLangKey(obj.description)): obj.amount + ' ' + settings.symbol + ' - ' + t(getLangKey(obj.description)), value: i }}
                                            index={i}
