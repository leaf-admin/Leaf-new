    ...
    <View style={styles.content}>
      ...
      <View style={styles.feeStructure}>
        ...
        <View style={styles.feeItem}>
          ...
          <Text style={styles.feeDescription}>Corridas acima de R$ 25,00 até R$ 50,00</Text>
        </View>

        <View style={styles.feeItem}>
          <View style={styles.feeHeader}>
            <Icon name="trending-up" type="material" color="#9C27B0" size={20} />
            <Text style={styles.feeTitle}>Corridas Acima de R$ 50</Text>
          </View>
          <Text style={styles.feeValue}>3%</Text>
          <Text style={styles.feeDescription}>Percentual sobre o valor bruto da corrida</Text>
        </View>
      </View>
