...
# 🚀 Script para fazer build e deploy do Dashboard JS na VPS
...
echo -e "${BLUE}🚀 DEPLOY DASHBOARD JS PARA VPS${NC}"
echo "======================================"
...
NEXT_PUBLIC_API_URL=https://dashboard.leaf.app.br/api
NEXT_PUBLIC_WS_URL=wss://dashboard.leaf.app.br/socket.io
ENVEOF
    
    # Limpar builds anteriores e arquivos TypeScript antigos
    rm -rf .next out node_modules
    find . -type f \( -name "*.ts" -o -name "*.tsx" \) ! -name "*.d.ts" -delete 2>/dev/null || true
