# 📊 DIAGRAMAS MERMAID - VERSÃO PURA (Para Mermaid Live Editor)

**Instruções:** Copie cada bloco de código abaixo e cole no [Mermaid Live Editor](https://mermaid.live/)

---

## 1. FLOWCHART - FLUXO COMPLETO DE CORRIDA
...
## 2. SEQUENCE DIAGRAM - INTERAÇÕES WEBSOCKET
...
## 3. FLOWCHART - LÓGICA DE DECISÃO DO MOTORISTA
...
## 4. FLOWCHART - LÓGICA DE DECISÃO DO PASSAGEIRO
...
## 5. SEQUENCE DIAGRAM - FLUXO DE PAGAMENTO
...
## 6. FLOWCHART - ESTADOS DA CORRIDA
...
## 7. SEQUENCE DIAGRAM - SISTEMA DE FILAS E MATCHING
...
## 8. FLOWCHART - TRATAMENTO DE ERROS
...
1. **Copie apenas o código entre ```mermaid e ```**
2. **Cole no [Mermaid Live Editor](https://mermaid.live/)**
3. **Visualize e exporte como PNG/SVG se necessário**

Cada diagrama está separado e pronto para uso individual!
