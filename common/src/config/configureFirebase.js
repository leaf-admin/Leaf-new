...
// Este arquivo NÃO deve ser importado pelo web-app!
...
if (!isWeb) {
    ...
    // Ambiente web: exporta objeto vazio e avisa
    firebase = {};
    // Opcional: console.warn('Tentou importar configureFirebase do common em ambiente web. Use o configureFirebase do web-app!');
}
