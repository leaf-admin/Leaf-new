...
const validateUserData = (req, res, next) => {
  ...
  // Validar role
  const validRoles = ['admin', 'manager', 'agent', 'viewer', 'support', 'development', 'super-admin'];
...
router.delete('/users/:userId', adminRateLimit, authenticateToken, authorizeRole(['super-admin']), async (req, res) => {
  try {
    const { userId } = req.params;
