...
describe('kyc biometric production policy', () => {
  ...
  test('requires all production biometric dependencies when enabled', () => {
    ...
    expect(result.blockers).toEqual(expect.arrayContaining([
      ...
      'KYC_AWS_COST_GUARD_ENABLED=true obrigatório para limitar sessões pagas AWS KYC por motorista.',
      'KYC_AWS_COST_PER_USER_DAILY_SESSION_LIMIT deve ser exatamente 20 na política aprovada.',
