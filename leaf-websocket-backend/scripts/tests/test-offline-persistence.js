/**
 * 🧪 TESTE DO SISTEMA DE PERSISTÊNCIA OFFLINE
 * Validação do funcionamento completo sem conexão
 */

const io = require('socket.io-client');
const AsyncStorage = require('@react-native-async-storage/async-storage');

console.log('🧪 TESTE DO SISTEMA DE PERSISTÊNCIA OFFLINE');
...
const mockNetInfo = {
  ...
  addEventListener: (callback) => {
    // Simular mudança de conectividade
    setTimeout(() => {
...
// Substituir NetInfo globalmente
