...
if [[ "$APPLY_ENV" == "true" ]]; then
  ...
  run_ssh "
    ...
    grep -E '^(LEAF_LAUNCH_PROFILE|ENABLE_DRIVER_WITHDRAWALS|ENABLE_REFERRAL_PROGRAMS|ENABLE_SOFT_BAN_ENFORCEMENT|ENABLE_ADMIN_MUTATIONS|HEALTH_SYSTEM_)=' \"\$ENV_FILE\"
  "
