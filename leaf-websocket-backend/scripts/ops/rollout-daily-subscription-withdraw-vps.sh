...
if [[ "$APPLY_ENV" == "true" ]]; then
  ...
  run_ssh "
    ...
    upsert SUBSCRIPTION_DAILY_FEE_NOMINAL_CENTS 1490
    upsert SUBSCRIPTION_DAILY_MIN_ACCOUNT_AGE_DAYS 60
    upsert SUBSCRIPTION_DAILY_NOTICE_DAYS 60
    upsert SUBSCRIPTION_DAILY_REQUIRE_CITY_ACTIVATION true
    upsert SUBSCRIPTION_DAILY_ELIGIBLE_CITIES ""
    upsert SUBSCRIPTION_PLUS_WAVE_1_DAILY_CENTS 490
    upsert SUBSCRIPTION_PLUS_WAVE_2_DAILY_CENTS 790
    upsert SUBSCRIPTION_PLUS_WAVE_3_DAILY_CENTS 1490
    upsert SUBSCRIPTION_PLUS_DAILY_CENTS 1490
    upsert SUBSCRIPTION_ELITE_DAILY_CENTS 0

    echo \"[rollout][env] arquivo: \$ENV_FILE\"
    grep -E '^(SUBSCRIPTION_SETTLE_ON_WITHDRAW|SUBSCRIPTION_SPLIT_RETENTION_ENABLED|SUBSCRIPTION_DAILY_BILLING_ENABLED|SUBSCRIPTION_BLOCK_ON_GRACE_EXPIRY|SUBSCRIPTION_BILLING_CONFIG_PATH|SUBSCRIPTION_DAILY_FEE_NOMINAL_CENTS|SUBSCRIPTION_DAILY_MIN_ACCOUNT_AGE_DAYS|SUBSCRIPTION_DAILY_NOTICE_DAYS|SUBSCRIPTION_DAILY_REQUIRE_CITY_ACTIVATION|SUBSCRIPTION_DAILY_ELIGIBLE_CITIES|SUBSCRIPTION_PLUS_WAVE_1_DAILY_CENTS|SUBSCRIPTION_PLUS_WAVE_2_DAILY_CENTS|SUBSCRIPTION_PLUS_WAVE_3_DAILY_CENTS|SUBSCRIPTION_PLUS_DAILY_CENTS|SUBSCRIPTION_ELITE_DAILY_CENTS)=' \"\$ENV_FILE\"
  "
