...
function buildSerializedBookingSnapshot(bookingData, regionHash, timestamp) {
    ...
    return {
        ...
        customerName: bookingData.customerName || bookingData.passengerName || '',
        ...
        routeCoordinates: serializeJSONField(bookingData.routeCoordinates, []),
        trafficSegments: serializeJSONField(bookingData.trafficSegments, []),
        ...
        paymentDriverReservationId: bookingData.paymentDriverReservationId || '',
        paymentDriverReservationDriverId: bookingData.paymentDriverReservationDriverId || '',
        paymentDriverReservationExpiresAt: bookingData.paymentDriverReservationExpiresAt || '',
        paymentDriverReservationTtlSeconds: String(bookingData.paymentDriverReservationTtlSeconds || ''),
        providerEnvironment: bookingData.providerEnvironment || bookingData.paymentProviderEnvironment || '',
        paymentProviderEnvironment: bookingData.paymentProviderEnvironment || bookingData.providerEnvironment || '',
        paymentProfileId: bookingData.paymentProfileId || '',
        paymentProfileReason: bookingData.paymentProfileReason || '',
        paymentProfileSource: bookingData.paymentProfileSource || '',
