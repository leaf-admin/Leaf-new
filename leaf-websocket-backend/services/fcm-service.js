    ...
    async sendRideStatusUpdate(userId, rideData) {
        try {
            ...
            const dataPayload = {
                ...
                vehicleModel: String(rideData.vehicleModel || rideData.driverVehicleModel || ''),
                driverVehicleModel: String(rideData.driverVehicleModel || rideData.vehicleModel || ''),
                vehiclePlate: String(rideData.vehiclePlate || rideData.driverVehiclePlate || ''),
                driverVehiclePlate: String(rideData.driverVehiclePlate || rideData.vehiclePlate || ''),
                vehicleColor: String(rideData.vehicleColor || rideData.driverVehicleColor || ''),
                driverVehicleColor: String(rideData.driverVehicleColor || rideData.vehicleColor || ''),
