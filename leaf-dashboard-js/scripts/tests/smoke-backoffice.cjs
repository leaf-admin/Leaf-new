    ...
    costControls: {
      ...
      skuMonitor: {
        ...
        summary: {
          ...
          netAfterInfraBRL: 9.89,
        },
        skus: [
          { provider: "google", sku: "places-cache-hit", calls: 0, unitCostBRL: 0, totalCostBRL: 0 },
          { provider: "woovi", sku: "pix-sandbox", calls: 0, unitCostBRL: 0, totalCostBRL: 0 },
        ],
      },
    },
    services: {
